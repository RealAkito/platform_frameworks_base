...
public class SoundSearchTile extends QSTileImpl<BooleanState> {
    ...
    public void handleClick() {
        ...
        // Shazam
        if (PixysUtils.isPackageInstalled(mContext, "com.shazam.android") || PixysUtils.isPackageInstalled(mContext, "com.shazam.encore.android")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.shazam.android.intent.actions.START_TAGGING");
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            mContext.startActivity(intent);
        // Soundhound
        } else if (PixysUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier.freemium") || PixysUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
