...
public class HeadsUpAppearanceController implements OnHeadsUpChangedListener,
    ...
    // DU Logo
    private final ImageView mEvoxLogo;
    ...
    private void setShown(boolean isShown) {
        ...
        if (mShown != isShown) {
            ...
            if (isShown) {
                ...
                if (mShowLogo) {
                    CrossFadeHelper.fadeOut(mEvoxLogo, CONTENT_FADE_DURATION/* duration */,
                                0 /* delay */, () -> mEvoxLogo.setVisibility(View.INVISIBLE));
                }
                ...
                if (mShowLogo) {
                    CrossFadeHelper.fadeIn(mEvoxLogo, CONTENT_FADE_DURATION /* duration */,
                                CONTENT_FADE_DELAY /* delay */);
                }
                if (mShowCarrierLabel == 2 || mShowCarrierLabel == 3) {
